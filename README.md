...
> **Note:** This is a fork of [leomccormack/Super-Hearing](https://github.com/leomccormack/Super-Hearing) with modifications to the UltrasonicSuperHearing plugin — renamed **USH-AmbiX** — adding a switchable 4-channel AmbiX output alongside the original binaural mode, plus two extra pitch-shift options. See [USH-AmbiX_CHANGES.md](USH-AmbiX_CHANGES.md) for details. All credit for the original research, hardware, and code below belongs to Leo McCormack and co-authors.
